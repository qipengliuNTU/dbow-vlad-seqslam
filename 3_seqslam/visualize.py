...
imgPath = '../datasets/city_centre/Images/'
num_of_img = len(os.listdir(imgPath)) // 2

# load the match
left_match_path = './results16/LoopClosure-left_camera-1-2-2473-left_camera-1-2-2473.mat'
right_match_path = './results16/LoopClosure-right_camera-2-2-2474-right_camera-2-2-2474.mat'

left_match = loadmat(left_match_path)
right_match = loadmat(right_match_path)

groundtruthPath = '../datasets/city_centre/CityCentreGroundTruth.mat'
...
gpsPath = '../datasets/city_centre/ImageCollectionCoordinates.mat'
gps = loadmat(gpsPath)
gps = gps['GPS']
...
for i in range(num_of_img):
    print("number of img: ", i, " , total number: ", num_of_img)
